...
CREATE TABLE `history` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `uid` (`uid`),
  KEY `transaction` (`transaction`,`datetime`,`symbol`,`shares`,`price`),
  KEY `transaction_2` (`transaction`,`datetime`,`symbol`,`shares`,`price`)
...
INSERT INTO `history` VALUES (7,13,'SELL','2016-03-18 14:42:09','FREE',100,0.0204),(8,13,'SELL','2016-03-18 14:42:19','FB',20,110.8360),(9,13,'BUY','2016-03-18 14:42:29','FB',50,110.8300);
...
INSERT INTO `portfolios` VALUES (1,13,'GOOG',40),(2,9,'FREE',50),(5,13,'SEB',11),(10,9,'GOOG',5),(11,9,'FB',10),(14,13,'FB',50);
...
-- Dump completed on 2016-03-18 16:21:40
